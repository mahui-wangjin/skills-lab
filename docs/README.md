...
- 当前新增设计文档：`./superpowers/specs/2026-05-25-reuse-first-guard-project-local-reuse.md`
- 上一轮设计文档：`./superpowers/specs/2026-04-23-reuse-first-guard-headless-native-refinement.md`
